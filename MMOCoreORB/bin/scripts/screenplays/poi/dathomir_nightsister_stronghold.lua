...
function NightSisterStrongholdScreenPlay:spawnMobiles()
	...
	spawnMobile("dathomir", "nightsister_protector",900,-4005.1,119.0,-60.0,-164,0)
	...
	spawnMobile("dathomir", "nightsister_elder",1200,-3976.1,131.5,-171.3,-169,0)
	spawnMobile("dathomir", "nightsister_elder",1200,-4003.5,121,-270.1,-54,0)
	spawnMobile("dathomir", "nightsister_elder",1200,-4155.3,121.0,-99.8,51,0)
	...
	spawnMobile("dathomir", "nightsister_protector",900,0.2,0.8,-54.7,-5,189379)
	spawnMobile("dathomir", "nightsister_elder",1200,-5.8,7.2,-3.0,135,189383)
	...
	spawnMobile("dathomir", "nightsister_sentinel",720,-89.6414,-100.547,-149.769,54,4115626)
	...
	spawnMobile("dathomir", "nightsister_ranger",720,-52.8,-68.7,-103.5,20,4115627)
	...
	spawnMobile("dathomir", "nightsister_ranger",720,-107.147,-68.531,-113.11,7,4115626)
	spawnMobile("dathomir", "nightsister_stalker",720,-118.707,-69.6862,-123.213,2,4115626)
	spawnMobile("dathomir", "nightsister_spell_weaver",720,-122.558,-69.332,-138.946,7,4115626)
	...
	spawnMobile("dathomir", "nightsister_spell_weaver",720,-121.94,-69.8514,-182.011,2,4115626)
	spawnMobile("dathomir", "nightsister_spell_weaver",720,-115.618,-69.9586,-198.215,7,4115626)
	...
	spawnMobile("dathomir", "nightsister_protector",900,-12.4,-64.0,-188.3,-2,4115624)
	...
	spawnMobile("dathomir", "nightsister_spell_weaver",720,37.6899,-52.6698,-143.418,7,4115623)
	spawnMobile("dathomir", "nightsister_sentry",720,17.99,-47.6612,-133.802,2,4115623)
	spawnMobile("dathomir", "nightsister_spell_weaver",720,-7.9093,-45.001,-143.0,9,4115623)
	...
	spawnMobile("dathomir", "nightsister_ranger",720,15.027,-40.2011,-76.6327,7,4115621)
...
-- Change Axkva to respawn once an hour!
function NightSisterStrongholdScreenPlay:axkvaKilled(pAxkvaMin)
	createEvent(3600 * 1000, "NightSisterStrongholdScreenPlay", "respawnAxkvaMin", nil, "")
